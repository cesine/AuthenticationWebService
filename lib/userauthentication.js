...
var util = require('util'),
  ...
  Connection = require("fielddb/api/corpus/Connection").Connection,
...
for (var userType in node_config.sampleUsers) {
  if (node_config.sampleUsers.hasOwnProperty(userType) && node_config.sampleUsers[userType].sampleUsers && node_config.sampleUsers[userType].sampleUsers.length > 0) {
    sampleUsers = sampleUsers.concat(node_config.sampleUsers[userType].sampleUsers);
  }
}
