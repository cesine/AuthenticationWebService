...
module.exports = function Users(args) {
  ...
  this.createUsers = function createUsers(req, res, next) {
  ...
  this.updateUsers = function updateUsers(req, res, next) {
  ...
  this.deleteUsers = function deleteUsers(req, res, next) {
    res.status(501).send({
      error: 'Forbidden: API method will not not implemented'
    });
  };
  this.addUserRoles = function addUserRoles(req, res, next) {
    res.send('addUserRoles');
  };
  this.updateUserRoles = function updateUserRoles(req, res, next) {
    res.send('updateUserRoles');
  };
  this.getUserRoles = function getUserRoles(req, res, next) {
    res.send('getUserRoles');
  };
  this.deleteUserRoles = function deleteUserRoles(req, res, next) {
